...
### 🏛️ SETAS — Correspondence Management System
> Full-stack application built for the Ministère des Habous et des Affaires Islamiques — Fès  

- 🔗 Backend (Laravel API): https://github.com/amine-xxl/APP-Gestion-Delais-BACK  
- 🔗 Frontend (React): https://github.com/amine-xxl/APP-Gestion-Delais-FRONT  

**Features:**
- 📥 Manage incoming/outgoing correspondence  
- ⏰ Deadline tracking with auto-calculation  
- 📧 Automated Gmail reminders  
- 📊 Statistics dashboard  
- 🖨️ Word document generation  
